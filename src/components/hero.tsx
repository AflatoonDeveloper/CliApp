...
import { ArrowUpRight, Check, Camera, BarChart3, Utensils } from "lucide-react";
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-12 max-w-2xl mx-auto leading-relaxed">
              Simply snap a photo of your meal and our AI instantly analyzes it,
              providing accurate nutritional information to help you make
              healthier choices.
            </p>
            ...
            <div className="mt-16 flex flex-col sm:flex-row items-center justify-center gap-8 text-sm text-gray-600">
              ...
              <div className="flex items-center gap-2">
                <Check className="w-5 h-5 text-green-500" />
                <span>Accurate nutritional data</span>
              </div>
            </div>
          </div>
        </div>
